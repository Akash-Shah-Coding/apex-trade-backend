          ...
          <ul>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📈 <span className="font-medium text-gray-800 dark:text-gray-100">Market Analysis: Trends for Q3 2024</span> The latest insights into market trends and what to expect in the upcoming quarter.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Jul 27, 2024</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🌍 <span className="font-medium text-gray-800 dark:text-gray-100">Global Trade Insights: Navigating New Regulations</span> An overview of the latest changes in global trade regulations and their impact.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Jul 20, 2024</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">💼 <span className="font-medium text-gray-800 dark:text-gray-100">Emerging Markets: Opportunities and Risks</span> Explore the potential and challenges in emerging markets for the next fiscal year.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Jul 13, 2024</span>
              </Link>
            </li>
