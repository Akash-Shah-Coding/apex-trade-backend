...
import { Accountdata, Accountolumns } from '../data';
            ...
            <div className="grid grid-cols-12 gap-6 mt-6">
                ...
                <div className="col-span-full lg:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl h-fit">
                    <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Account Copier Policies</h2>
                    </header>
                    <div className="p-3 overflow-auto">
                        ...
                        {/* Table */}
                        <DropdownRowTable columns={Accountolumns} rows={Accountdata} />
                    </div>
