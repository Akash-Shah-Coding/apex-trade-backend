...
const MarketNewPosition = () => {
    ...
    return (
        <>
            ...
            <DashboardActions Title="Market new Position"/>
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    ...
                    <div className="p-4 dark:bg-gray-800 bg-white rounded-md h-fit">
                        ...
                        {/* Buy/Sell Buttons */}
                        <div className="flex flex-col sm:flex-row justify-between mb-5 space-y-2 sm:space-y-0 sm:space-x-4">
                            <button className="w-full sm:w-1/2 bg-red-500 text-white p-2 rounded">SELL @ Market</button>
                            <button className="w-full sm:w-1/2 bg-green-500 text-white p-2 rounded">BUY @ Market</button>
                        </div>
...
export default MarketNewPosition