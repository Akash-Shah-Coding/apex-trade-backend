...
function DashboardCard01({ title, salesData, percentageChange }) {
  ...
  return (
    ...
    <div className="px-5 pt-5">
      ...
      <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Data</div>
      <div className="flex items-start">
        <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">{salesData}</div>
        <div className={`text-sm font-medium ${percentageChange >= 0 ? 'text-green-700' : 'text-red-700'} px-1.5 bg-${percentageChange >= 0 ? 'green' : 'red'}-500/20 rounded-full`}>
